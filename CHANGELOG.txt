...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|Embed|Stripe|Twilio]
- [Updated] Delus JS Dependencies [codemirror|mustache|tinymce]
- [Updated] Delus CSS Dependencies [Font-Awesome]
...
- [Removed] Intl PHP extension as requirement for Delus
...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|HybridAuth v3|Stripe|Twilio]
- [Updated] Delus JS Dependencies [jQuery|bootstrap.colorpicker|bootstrap.select|codemirror|tinymce]
- [Updated] Delus CSS Dependencies [Font-Awesome]
...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|Stripe|Twilio]
- [Updated] Delus JS Dependencies [bootstrap|mustache|jquery-ui|datatables|bootstrap.colorpicker|bootstrap.datetimepicker|bootstrap.select|codemirror|moment|tinymce]
- [Updated] Delus CSS Dependencies [Font-Awesome]

- [Added] Delus Default Theme v2.0 with Bootsrap 4+
...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|Embed|HybridAuth|PHPMailer|ReCaptcha|Smarty|Stripe|Twilio]
- [Updated] Delus JS Dependencies [mustache|bootstrap.select|codemirror|metismenu|moment|readmore|tinymce]
- [Updated] Delus CSS Dependencies [Font-Awesome]
...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|Embed|HybridAuth|Smarty|Stripe|Twilio]
- [Updated] Delus JS Dependencies [autosize|bootstrap.colorpicker|codemirror|datatables|mediaelement|metismenu|moment|tinymce]
- [Updated] Delus CSS Dependencies [Font-Awesome]
...
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|Stripe|Twilio]
- [Updated] Delus JS Dependencies [jQuery|dataTables|mediaelement|metisMenu|moment|noty|tinymce]
- [Updated] Delus CSS Dependencies [Font-Awesome|Flag-Icon]
...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [Twilio]
- [Updated] Delus CSS Dependencies [Font-Awesome(v5)]
...
- [Updated] System Security
- [Updated] System Optimization
- [Updated] Delus Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|ReCaptcha|Smarty|Stripe|Twilio]
- [Updated] Delus JS Dependencies [jQuery|jquery.form|jquery.inview|jquery.geocomplete|autosize|moment|mediaelementplayer|bootstrap.select|bootstrap.datetimepicker|bootstrap.colorpicker|metisMenu|dataTables]
- [Updated] Installer Wizard & Pre-Installation Check
- [Updated] Delus GTmetrix Optimization
- [Updated] Delus Google PageSpeed Optimization
...
#== v2.4.2 == ( 21-03-2017 )
- [Updated] System optimization
- [Updated] Delus JS Dependencies [mediaelementplayer]
...
- [Updated] System optimization
- [Updated] Delus Libs [AWS|Embed|HybridAuth|PayPal|PHPMailer|reCAPTCHA|Smarty|Stripe|Twilio]
- [Updated] Delus JS Dependencies [jQuery|Bootstrap|Mustache|html5shiv|slimscroll|autosize|readmore|moment|datetimepicker|DataTables]
- [Updated] Delus CSS Dependencies [Font-Awesome|Twemoji-Awesome|Flag-Icon]
- [Updated] Installer Wizard & Pre-Installation Check
...
- [Updated] Delus Libs [PHPMailer]

#== v2.3 == ( 03-09-2016 )
- [Updated] Delus Dependencies [Bootstrap|Font-Awesome|Flag-Icon|Twemoji-Awesome]
...
#== v2.2.3 == ( 26-07-2016 )
- [Updated] Delus Dependencies [Smarty|HybridAuth|Google reCAPTCHA]
...
- [Added] Update all Delus Dependencies to latest version
...
#== v2.1 == ( 16-02-2016 )
- [Added] Delus 2.1 Structure for better caching and performance
- [Added] Delus APIs v1.0
