...
try {
  ...
  switch ($_POST['do']) {
    case 'start':
      // create live post
      $post_id = $user->create_live_post($_POST['agora_channel_name'], $_POST['video_thumbnail'], $_POST['node'], $_POST['node_id'], $_POST['tips_enabled'], $_POST['for_subscriptions'], $_POST['is_paid'], $_POST['post_price']);
