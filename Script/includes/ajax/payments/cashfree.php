...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("packages", $package['price'], $package['package_id'], $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
    ...
    case 'wallet':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("wallet", $_POST['price'], null, $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
    ...
    case 'donate':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("donate", $_POST['price'], $_POST['post_id'], $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
    ...
    case 'subscribe':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("subscribe", $monetization_plan['price'], $_POST['plan_id'], $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
    ...
    case 'paid_post':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("paid_post", $post['post_price'], $_POST['post_id'], $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
    ...
    case 'movies':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("movies", $movie['price'], $_POST['movie_id'], $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
    ...
    case 'marketplace':
      ...
      // get cashfree payment session id
      $return['payment_session_id'] = cashfree("marketplace", $orders_collection['total'], $_POST['orders_collection_id'], $_POST['billing_name'], $_POST['billing_email'], $_POST['billing_phone']);
      break;
