...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      // get verotel link
      $link = verotel("packages", $package['price'], $package['package_id']);
      break;
    ...
    case 'wallet':
      ...
      // get verotel link
      $link = verotel("wallet", $_POST['price']);
      break;
    ...
    case 'donate':
      ...
      // get verotel link
      $link = verotel("donate", $_POST['price'], $_POST['post_id']);
      break;
    ...
    case 'subscribe':
      ...
      // get verotel link
      $link = verotel("subscribe", $monetization_plan['price'], $_POST['plan_id']);
      break;
    ...
    case 'paid_post':
      ...
      // get verotel link
      $link = verotel("paid_post", $post['post_price'], $_POST['post_id']);
      break;
    ...
    case 'movies':
      ...
      // get verotel link
      $link = verotel("movies", $movie['price'], $_POST['movie_id']);
      break;
    ...
    case 'marketplace':
      ...
      // get verotel link
      $link = verotel("marketplace", $orders_collection['total'], $_POST['orders_collection_id']);
      break;
