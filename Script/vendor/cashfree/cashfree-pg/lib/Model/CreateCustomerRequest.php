    ...
    */
    ...
    public function setCustomerPhone($customer_phone)
    {
        ...
        if ((mb_strlen($customer_phone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_phone when calling CreateCustomerRequest., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($customer_phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_phone when calling CreateCustomerRequest., must be bigger than or equal to 10.');
        }
