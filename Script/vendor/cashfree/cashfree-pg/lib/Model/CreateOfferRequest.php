...
class CreateOfferRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['offer_meta'] === null) {
            $invalidProperties[] = "'offer_meta' can't be null";
        }
        if ($this->container['offer_tnc'] === null) {
            $invalidProperties[] = "'offer_tnc' can't be null";
        }
        if ($this->container['offer_details'] === null) {
            $invalidProperties[] = "'offer_details' can't be null";
        }
        if ($this->container['offer_validations'] === null) {
            $invalidProperties[] = "'offer_validations' can't be null";
        }
     ...
     * Gets offer_meta
     *
     * @return \Cashfree\Model\OfferMeta
     */
     ...
     * Sets offer_meta
     *
     * @param \Cashfree\Model\OfferMeta $offer_meta offer_meta
     *
     * @return self
     */
     ...
     * Gets offer_tnc
     *
     * @return \Cashfree\Model\OfferTnc
     */
     ...
     * Sets offer_tnc
     *
     * @param \Cashfree\Model\OfferTnc $offer_tnc offer_tnc
     *
     * @return self
     */
     ...
     * Gets offer_details
     *
     * @return \Cashfree\Model\OfferDetails
     */
     ...
     * Sets offer_details
     *
     * @param \Cashfree\Model\OfferDetails $offer_details offer_details
     *
     * @return self
     */
     ...
     *
     * @return \Cashfree\Model\OfferValidations
     */
     ...
     *
     * @param \Cashfree\Model\OfferValidations $offer_validations offer_validations
     *
     * @return self
     */
