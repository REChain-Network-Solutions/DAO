 ...
 */
class Netbanking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Netbanking';
    ...
    */
     ...
     * Sets channel
     *
     * @param string $channel The channel for netbanking will always be `link`
     *
     * @return self
     */
     ...
     *
     * @param int|null $netbanking_bank_code Bank code
     *
     * @return self
     */
     ...
     *
     * @param string|null $netbanking_bank_name String code for bank
     *
     * @return self
     */
