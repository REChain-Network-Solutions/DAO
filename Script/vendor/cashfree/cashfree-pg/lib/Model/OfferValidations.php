...
/**
 * OfferValidations Class Doc Comment
 *
 * @category Class
 ...
 */
class OfferValidations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferValidations';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['max_allowed'] < 1)) {
    ...
    public function setMinAmount($min_amount)
    {
        ...
        if (($min_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $min_amount when calling OfferValidations., must be bigger than or equal to 1.');
        }
     ...
     * Sets max_allowed
     *
     * @param float $max_allowed Maximum Amount for Offer to be Applicable
     *
     * @return self
     */
     ...
     * Gets payment_method
     *
     * @return \Cashfree\Model\OfferValidationsPaymentMethod
     */
     ...
     * Sets payment_method
     *
     * @param \Cashfree\Model\OfferValidationsPaymentMethod $payment_method payment_method
     *
     * @return self
     */
