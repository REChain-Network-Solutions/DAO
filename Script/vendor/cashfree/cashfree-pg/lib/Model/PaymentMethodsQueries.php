...
/**
 * PaymentMethodsQueries Class Doc Comment
 *
 * @category Class
 * @description Payment Method Query Object
 * @package  Cashfree
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodsQueries implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodsQueries';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Amount of the order.
     *
     * @return self
     */
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling PaymentMethodsQueries., must be bigger than or equal to 1.');
        }
