...
/**
 * SimulationResponse Class Doc Comment
 *
 * @category Class
 * @description Simulation response object
 * @package  Cashfree
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SimulationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SimulationResponse';
    ...
    {
        $this->setIfExists('simulation_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['simulation_id'];
    }

    /**
     * Sets simulation_id
     *
     * @param string|null $simulation_id simulation_id
     *
     * @return self
     */
    public function setSimulationId($simulation_id)
    {
        if (is_null($simulation_id)) {
            throw new \InvalidArgumentException('non-nullable simulation_id cannot be null');
        }
        $this->container['simulation_id'] = $simulation_id;
     ...
     *
     * @return \Cashfree\Model\EntitySimulationResponse|null
     */
     ...
     *
     * @param \Cashfree\Model\EntitySimulationResponse|null $entity_simulation entity_simulation
     *
     * @return self
     */
