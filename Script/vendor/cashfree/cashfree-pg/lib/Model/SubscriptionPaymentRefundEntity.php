...
/**
 * SubscriptionPaymentRefundEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscriptionPaymentRefundEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionPaymentRefundEntity';
    ...
    */
     ...
     * Sets refund_id
     *
     * @param string|null $refund_id A unique ID passed by merchant for identifying the refund.
     *
     * @return self
     */
     ...
     * Sets cf_refund_id
     *
     * @param string|null $cf_refund_id Cashfree subscription payment refund reference number.
     *
     * @return self
     */
     ...
     * Sets refund_amount
     *
     * @param float|null $refund_amount The refund amount.
     *
     * @return self
     */
     ...
     * Sets refund_speed
     *
     * @param string|null $refund_speed Refund speed. Can be INSTANT or NORMAL.
     *
     * @return self
     */
     ...
     * Sets refund_status
     *
     * @param string|null $refund_status Status of the refund.
     *
     * @return self
     */
