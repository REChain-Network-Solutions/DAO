...
/**
 * UpdateOrderExtendedRequest Class Doc Comment
 *
 * @category Class
 * @description Request Body to Update extended data related to order
 * @package  Cashfree
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateOrderExtendedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOrderExtendedRequest';
    ...
    */
     ...
     *
     * @return \Cashfree\Model\ShipmentDetails[]
     */
     ...
     *
     * @param \Cashfree\Model\ShipmentDetails[] $shipment_details Shipment details, such as the tracking company, tracking number, and tracking URLs, associated with the shipping of an order. Either `shipment_details` or `order_delivery_status` is required.
     *
     * @return self
     */
