...
/**
 * UpdateTerminalStatusRequest Class Doc Comment
 *
 * @category Class
 * @description Request body to update terminal status.
 * @package  Cashfree
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateTerminalStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTerminalStatusRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terminal_status'] === null) {
            $invalidProperties[] = "'terminal_status' can't be null";
        }
     ...
     *
     * @param string $terminal_status Status of the terminal to be updated. possible values - ACTIVE, INACTIVE.
     *
     * @return self
     */
