...
/**
 * UploadVendorDocsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UploadVendorDocsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UploadVendorDocsRequest';
    ...
    */
     ...
     * Sets doc_value
     *
     * @param \SplFileObject|null $doc_value Enter the display name of the uploaded file.
     *
     * @return self
     */
     ...
     * Sets file
     *
     * @param string|null $file Select the document that should be uploaded or provide the path of that file. You cannot upload a file that is more than 2MB in size.
     *
     * @return self
     */
