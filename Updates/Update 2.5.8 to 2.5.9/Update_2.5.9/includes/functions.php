...
function check_system_requirements() {
    ...
    if(version_compare( $required_php_version, $php_version, '>')) {
        _error("Installation Error", sprintf('<p class="text-center">Your server is running PHP version %s but Delus requires at least %s.</p>', $php_version, $required_php_version));
    }
        ...
        switch ($args[0]) {
            case 'DB_ERROR':
                ...
                $message = "<div class='text-left'><h1>"."Error establishing a database connection"."</h1>
                            ...
                            <p>"."If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the"." <a href='http://support.Sorokin Dmitry Olegovich.com'>"."Delus Support".".</a></p>
                            </div>";
                break;
