        ...
        <div class="comment-inner js_notifier-flasher">
          ...
          <div class="comment-author">
            ...
            {if $_comment['user_subscribed']}
              <i data-toggle="tooltip" data-placement="top" title='{__($_comment['package_name'])} {__('Member')}' class="fa fa-bolt fa-fw pro-badge"></i>
            {/if}
          </div>
          <!-- author -->
          ...
          <div class="pointer unselectable reactions-wrapper {if $_comment['i_react']}js_unreact-comment{/if}" data-reaction="{$_comment['i_reaction']}">
            ...
            <div class="reactions-container">
              {foreach $reactions as $reaction}
                <div class="reactions_item reaction reaction-{$reaction@iteration} js_react-comment" data-reaction="{$reaction['reaction']}" data-reaction-color="{$reaction['color']}" data-title="{$reaction['title']}">
