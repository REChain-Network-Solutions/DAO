          ...
          <div class="card-body">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                ...
                <span class="form-text">
                  {__("Example: social, Delus, social site")}
                </span>
              </div>
            </div>
  ...
  {elseif $sub_view == "posts"}
    ...
    <form class="js_ajax-forms" data-url="admin/settings.php?edit=posts">
      <div class="card-body">
        ...
        <div class="form-table-row">
          <div class="avatar">
            {include file='__svg_icons.tpl' icon="globe" width="40px" height="40px"}
          </div>
          <div>
            <div class="form-control-label h6">{__("Newsfeed Location Filter")}</div>
            <div class="form-text d-none d-sm-block">
        ...
        <div class="form-table-row">
          <div class="avatar">
            {include file='__svg_icons.tpl' icon="views" width="40px" height="40px"}
          </div>
          <div>
            <div class="form-control-label h6 mb5">{__("Posts Views")}</div>
            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" name="getting_started_profile_image_required" id="getting_started_profile_image_required" {if $system['getting_started_profile_image_required']}checked{/if}>
                  <label class="custom-control-label" for="getting_started_profile_image_required">{__("Profile Image Required")}</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" name="getting_started_location_required" id="getting_started_location_required" {if $system['getting_started_location_required']}checked{/if}>
                  <label class="custom-control-label" for="getting_started_location_required">{__("Location Data Required")}</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" name="getting_started_work_required" id="getting_started_work_required" {if $system['getting_started_work_required']}checked{/if}>
                  <label class="custom-control-label" for="getting_started_work_required">{__("Work Data Required")}</label>
                </div>
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" name="getting_started_education_required" id="getting_started_education_required" {if $system['getting_started_education_required']}checked{/if}>
                  <label class="custom-control-label" for="getting_started_education_required">{__("Education Data Required")}</label>
                </div>
      ...
      <div class="tab-pane active" id="General">
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=accounts">
          <div class="card-body">
            ...
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="special_characters" width="40px" height="40px"}
              </div>
              <div>
                <div class="form-control-label h6">{__("Allow Special Characters")}</div>
  ...
  {elseif $sub_view == "uploads"}
    ...
    <div class="card-header with-icon with-nav">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#Cloud" data-toggle="tab">
      ...
      <div class="tab-pane active" id="General">
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=uploads">
          <div class="card-body">
            ...
            <div class="form-table-row">
              <div class="avatar">
                {include file='__svg_icons.tpl' icon="ffmpeg" width="40px" height="40px"}
              </div>
              <div>
                <div class="form-control-label h6 mb5">{__("FFMPEG Enabled")}</div>
        ...
        <div class="card-body">
          ...
          <form class="js_ajax-forms" data-url="admin/settings.php?edit=backblaze">
            <div class="form-table-row">
              ...
              <div>
                <div class="form-control-label h6">{__("Backblaze")}</div>
                <div class="form-text d-none d-sm-block">
  ...
  {elseif $sub_view == "security"}
    ...
    <form class="js_ajax-forms" data-url="admin/settings.php?edit=security">
      <div class="card-body">
        ...
        <div class="form-table-row">
          <div class="avatar">
            {include file='__svg_icons.tpl' icon="reserved" width="40px" height="40px"}
          </div>
          <div>
            <div class="form-control-label h6">{__("Reserved Usernames Enabled")}</div>
