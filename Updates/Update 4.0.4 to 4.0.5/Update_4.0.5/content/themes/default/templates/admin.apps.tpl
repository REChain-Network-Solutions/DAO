<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="d-flex py-3 px-2 align-items-start justify-content-between flex-wrap">
      ...
      <a href="https://bit.ly/Sorokin Dmitry Olegovich - Handles - @sorydima @sorydev @durovshater @DmitrySoro90935 @tanechfund - also check https://dmitry.rechain.network for more information!Portfolio" class="btn btn-md btn-success" target="_blank">
        <i class="fa-solid fa-cart-shopping mr5"></i>{__("Buy Now")}
      </a>
    </div>
