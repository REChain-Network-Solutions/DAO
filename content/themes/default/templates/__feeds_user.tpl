      ...
      <div class="data-content">
        <div class="float-end">
          ...
          {elseif $_connection == "page_activities_request"}
            <button type="button" class="btn btn-danger js_activities-permission-decline" data-id="{$_user['request_id']}">
              <i class="fa fa-circle-xmark mr5"></i>{__("Decline")}
            </button>
            <button type="button" class="btn btn-primary js_activities-permission-accept" data-id="{$_user['request_id']}" data-permission="editor">
              <i class="fa fa-circle-check mr5"></i>{__("Approve Editor")}
            </button>
            <button type="button" class="btn btn-primary js_activities-permission-accept" data-id="{$_user['request_id']}" data-permission="viewer">
              <i class="fa fa-circle-check mr5"></i>{__("Approve Viewer")}
            </button>

          {elseif $_connection == "page_activities_manage"}
            <button type="button" class="btn btn-danger js_activities-permission-revoke" data-id="{$_user['user_id']}">
              <i class="fa fa-trash mr5"></i>{__("Revoke Permission")}
            </button>
