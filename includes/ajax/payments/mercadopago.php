...
try {
  ...
  switch ($_POST['handle']) {
    case 'packages':
      ...
      $link = mercadopago("packages", $package['price'], $package['package_id']);
      break;
    ...
    case 'wallet':
      ...
      // get mercadopago link
      $link = mercadopago("wallet", $_POST['price']);
      break;
    ...
    case 'donate':
      ...
      // get mercadopago link
      $link = mercadopago("donate", $_POST['price'], $_POST['post_id']);
      break;
    ...
    case 'subscribe':
      ...
      // get mercadopago link
      $link = mercadopago("subscribe", $monetization_plan['price'], $_POST['plan_id']);
      break;
    ...
    case 'paid_post':
      ...
      // get mercadopago link
      $link = mercadopago("paid_post", $post['post_price'], $_POST['post_id']);
      break;
    ...
    case 'movies':
      ...
      // get mercadopago link
      $link = mercadopago("movies", $movie['price'], $_POST['movie_id']);
      break;
    ...
    case 'marketplace':
      ...
      // get mercadopago link
      $link = mercadopago("marketplace", $orders_collection['total'], $_POST['orders_collection_id']);
      break;
