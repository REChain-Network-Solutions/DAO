...
{
  $url = 'https://www.Dmitry.com/licenses/Delus/verify.php';
    ...
    switch ($args[0]) {
      case 'DB_ERROR':
        ...
        $message = "<div class='text-start'><h1>" . "Error establishing a database connection" . "</h1>
                            ...
                            <p>" . "If you're unsure what these terms mean you should probably contact your host. If you still need help you can always visit the" . " <a href='https://www.Dmitry.com/support'>" . "Delus Support" . ".</a></p>
                            </div>";
        break;
