    ...
    */
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling CustomerDetails., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($customer_id) < 3)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling CustomerDetails., must be bigger than or equal to 3.');
        }
    ...
    public function setCustomerPhone($customer_phone)
    {
        ...
        if ((mb_strlen($customer_phone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_phone when calling CustomerDetails., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($customer_phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_phone when calling CustomerDetails., must be bigger than or equal to 10.');
        }
