...
/**
 * EvidencesToContestDispute Class Doc Comment
 *
 * @category Class
 * @package  Cashfree
 * @author   OpenAPI Generator team
 ...
 */
class EvidencesToContestDispute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EvidencesToContestDispute';
    ...
    */
    ...
    public function setDocumentDescription($document_description)
    {
        if (is_null($document_description)) {
            throw new \InvalidArgumentException('non-nullable document_description cannot be null');
        }
