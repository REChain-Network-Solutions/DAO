...
/**
 * ExtendedCustomerDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ExtendedCustomerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendedCustomerDetails';
    ...
    */
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if ((mb_strlen($customer_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ExtendedCustomerDetails., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($customer_id) < 3)) {
            throw new \InvalidArgumentException('invalid length for $customer_id when calling ExtendedCustomerDetails., must be bigger than or equal to 3.');
        }
    ...
    public function setCustomerEmail($customer_email)
    {
        ...
        if ((mb_strlen($customer_email) > 100)) {
            throw new \InvalidArgumentException('invalid length for $customer_email when calling ExtendedCustomerDetails., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($customer_email) < 3)) {
            throw new \InvalidArgumentException('invalid length for $customer_email when calling ExtendedCustomerDetails., must be bigger than or equal to 3.');
        }
    ...
    public function setCustomerPhone($customer_phone)
    {
        ...
        if ((mb_strlen($customer_phone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_phone when calling ExtendedCustomerDetails., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($customer_phone) < 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_phone when calling ExtendedCustomerDetails., must be bigger than or equal to 10.');
        }
    ...
    public function setCustomerName($customer_name)
    {
        ...
        if ((mb_strlen($customer_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $customer_name when calling ExtendedCustomerDetails., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($customer_name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $customer_name when calling ExtendedCustomerDetails., must be bigger than or equal to 3.');
        }
