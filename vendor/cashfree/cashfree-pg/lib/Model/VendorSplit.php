 ...
 */
class VendorSplit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VendorSplit';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Amount which will be associated with this vendor
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float|null $percentage Percentage of order amount which shall get added to vendor account
     *
     * @return self
     */
